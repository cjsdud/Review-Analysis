...
//
// 자산 교체:
//   `frontend/src/assets/branding/reviewfit-title.svg` 또는 `.png` 가 공식 워드마크.
//   PNG 로 바꾸려면 같은 경로에 reviewfit-title.png 를 두고 아래 import 만 .png 로 변경.
//
// 접근성:
...
import wordmark from '../assets/branding/reviewfit-title.svg';
